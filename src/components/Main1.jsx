...
export const Main1 = () => {
  return (
    <div className="flex justify-items-center w-[1440px] h-[556px]">
      <div className="flex w-7xl h-[364px] pl-20 pr-20 pt-24 pb-24">
        <div className="w-[600px] h-[364px] flex-col  ">
          ...
          <div className="h-14 pt-14 pb-14">
            <div className="flex">
              <img src="./loc.png" alt="" /> Ulaanbaatar, Mongolia
            </div>
            <div className="flex ">
              <img className="h-2 w-2" src="./tseg.png" alt="" /> Available for
              new projects
            </div>
          </div>
