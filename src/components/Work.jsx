...
export const Work = () => {
  return (
    <div className="flex flex-col pl-20 pr-20 pb-24 pt-24 bg-gray-900">
      ...
      <div className=" flex flex-col rounded-xl bg-gray-800 space-y-12">
        {Ework.map(({ image, title, text }, index) => (
          <div
            className="flex"
            style={{ flexDirection: index % 2 === 0 ? "row" : "row-reverse" }}
          >
            <div className="flex justify-center items-center rounded-xl w-xl h-[480px] bg-gray-600">
            ...
            <div className="w-xl flex flex-col pt-12 pr-12 pl-12 ">
              ...
              <div className="w-[480px] space-x-2 space-y-2 pb-6 ">
                <button className="rounded-xl bg-gray-500 w-[79px] h-7 pb-4">
                  React
                </button>
                <button className="rounded-xl bg-gray-500 w-[87px] h-7 pb-4">
                  Next.js
                </button>
                <button className="rounded-xl bg-gray-500 w-[115px] h-7 pb-4">
                  Typescript
                </button>
                <button className="rounded-xl bg-gray-500 w-[87px] h-7 pb-4">
                  Nest.js
                ...
                <button className="rounded-xl bg-gray-500 w-[81px] h-7 pb-4">
                  Figma
                </button>
                <button className="rounded-xl bg-gray-500 w-[115px] h-7 pb-4">
                  Cypress
                ...
                <button className="rounded-xl bg-gray-500 w-[60px] h-7 pb-4">
                  Git
                </button>
              </div>
